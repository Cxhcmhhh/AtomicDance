...
PyTorch3D is a compiled dependency and must match the installed PyTorch and
CUDA versions. If its installation from `requirements.txt` fails, install
PyTorch3D 0.7.1 separately with the matching CUDA toolchain.
